...
export default class AlikeUpdatePage {
  getPageTitle() {
    return element(by.id('proposalApp.alike.home.createOrEditLabel'));
  }
  ...
  findTextInput() {
    return element(by.css('input#alike-prop-text'));
  }
  ...
  findCreatedDateInput() {
    return element(by.css('input#alike-prop-createdDate'));
  }
  ...
  getAuthorSelect() {
    return element(by.css('select#alike-prop-author'));
  }
  ...
  getProposalSelect() {
    return element(by.css('select#alike-prop-proposal'));
  }
