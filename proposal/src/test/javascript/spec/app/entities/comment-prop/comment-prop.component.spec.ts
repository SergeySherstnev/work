...
import CommentPropComponent from '@/entities/comment-prop/comment-prop.vue';
import CommentPropClass from '@/entities/comment-prop/comment-prop.component';
...
describe('Component Tests', () => {
  describe('CommentProp Management Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<CommentPropClass>(CommentPropComponent, {
        store,
        i18n,
        localVue,
