            ...
            <div class="col-md-8">
                ...
                <div>
                    <b-alert show variant="warning">
                      ...
                      <span v-text="$t('global.messages.info.authenticated.link')">sign in </span>
                      <span v-text="$t('global.messages.info.authenticated.suffix')">, use your domain login and password.</span>
                    </b-alert>
                </div>
            </div>
        </div>
