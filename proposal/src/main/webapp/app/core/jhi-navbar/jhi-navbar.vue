    ...
    <b-navbar toggleable="md" type="dark" class="jh-navbar">
        <div class="jh-logo-container float-left">
            ...
            <b-navbar-brand class="logo float-left" b-link to="/">
                ...
                <span v-text="$t('global.title')" class="navbar-title">proposal</span> <span class="navbar-version">{{version}}</span>
            </b-navbar-brand>
        </div>
            ...
            <b-navbar-nav class="ml-auto">
                ...
                <b-nav-item
                    ...
                    <span>
                        ...
                        <span v-text="$t('global.menu.browse')">Browse Proposals</span>
                    </span>
                </b-nav-item>
                <b-nav-item
                    to="/proposal/new"
                    ...
                    <span>
                        ...
                        <span v-text="$t('global.menu.add')">Add Proposal</span>
                    </span>
                </b-nav-item>
                ...
                <b-nav-item-dropdown
                    ...
                    <b-dropdown-item to="/entity/proposal-prop">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.proposalProp')">Proposal</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/history-prop">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.historyProp')">History</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/tag-prop">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.tagProp')">Tag</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/comment-prop">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.commentProp')">Comment</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/alike-prop">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.alikeProp')">Like</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/entity/quotes-prop">
                        <font-awesome-icon icon="asterisk" />
                        <span v-text="$t('global.menu.entities.quotesProp')">Quotes</span>
                    </b-dropdown-item>
