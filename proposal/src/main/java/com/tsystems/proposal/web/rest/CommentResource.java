...
/**
 * REST controller for managing {@link com.tsystems.proposal.domain.Comment}.
 */
@RestController
@RequestMapping("/api")
public class CommentResource {
     ...
     */
    @GetMapping("/comments")
    public ResponseEntity<List<Comment>> getAllComments(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder, @RequestParam(required = false, defaultValue = "0") Long proposalId,  @RequestParam(required = false, defaultValue = "false") boolean eagerload) {
        log.debug("REST request to get a page of Comments");
        log.debug("proposalId = " + proposalId + ", eagerload=" +eagerload );
        ...
        //} else {
            if (proposalId <= 0) {
                ...
                page = commentService.findByProposal(proposalId, pageable);
                log.info("findByProposal result: page = " + page.toString() );
            }
        //}
