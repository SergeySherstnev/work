...
import com.tsystems.proposal.config.Constants;
import com.tsystems.proposal.domain.User;
import com.tsystems.proposal.repository.UserRepository;
import com.tsystems.proposal.repository.search.UserSearchRepository;
import com.tsystems.proposal.security.AuthoritiesConstants;
import com.tsystems.proposal.service.MailService;
...
import com.tsystems.proposal.web.rest.errors.EmailAlreadyUsedException;
import com.tsystems.proposal.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
    ...
    /**
     * {@code GET /users/managers} : get all users with role MANAGER.
     *
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body all users who has role MANAGER.
     */
    @GetMapping("/users/managers")
    public ResponseEntity<List<UserDTO>> getManagers() {
        final List<UserDTO> res = userService.getAllUsersByRole(AuthoritiesConstants.MANAGER);
