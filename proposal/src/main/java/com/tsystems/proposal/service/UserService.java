...
import com.tsystems.proposal.repository.AuthorityRepository;
...
import com.tsystems.proposal.service.util.RandomUtil;
import com.tsystems.proposal.web.rest.errors.*;
...
public class UserService {
    ...
    public List<UserDTO> getAllUsersByRole(String role) {
        return userRepository.findAllByRoles(role).stream().map(UserDTO::new).collect(Collectors.toList());
    }
